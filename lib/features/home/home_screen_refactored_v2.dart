...
class _Hybrid2AppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  // Helper method untuk build title dengan glow effect
  ...
  // Helper method untuk build subtitle
...
class _LeagueCardState extends State<_LeagueCard> {
              ...
              child: Stack(
                children: [
                  _buildCardBackground(
                      primaryColor, secondaryColor, animDuration),
                  HoverLine(
  ...
  // Helper to build card background with extracted sub-widgets
  Widget _buildCardBackground(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          // Extracted sub-widget: Logo Container
          LeagueLogoContainer(
          ...
          // Extracted sub-widget: League Info
          LeagueInfo(
            leagueName: widget.leagueName,
            isHovered: _isHovered,
          ),
          const SizedBox(width: 16),
          // Extracted sub-widget: Action Button
          ActionButton(
            isHovered: _isHovered,
            animDuration: animDuration,
          ),
